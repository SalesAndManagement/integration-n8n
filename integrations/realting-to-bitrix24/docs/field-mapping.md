...
> Ліва колонка — **припущені** назви полів Realting. Точні назви видно командою
> `realting-sync probe`. Модуль `normalize.py` шукає значення за списком варіантів, тому
